...
function AddYourPersonalInformation() {
    return (
        <div>
            <h1 className="capitalize text-2xl font-bold text-[#0C7203]" >add your personal infromation</h1>
            ...
            <div className='mt-5'>
                ...
                <div className='flex flex-col md:flex-row justify-between'>
                    ...
                    <div className='md:w-[45%] mt-5 '>
                        <label className='text-black font-bold capitalize ' htmlFor="hostelprovidername">hostel provider name</label>
                        <br />
                        <input className='bg-[#D9D9D9] px-2 py-2 mt-2 rounded-sm w-full' type="text" name="hostelprovidername" id="hostelprovidername" />
                    </div>
                ...
                <div className='flex flex-col md:flex-row justify-between md:mt-10'>
                    ...
                    <div className='md:w-[45%] mt-5 '>
                        <label className='text-black font-bold capitalize ' htmlFor="ChildernatHome">Childern at Home</label>
                        <br />
                        <input className='bg-[#D9D9D9] px-2 py-2 mt-2 rounded-sm w-full' type="text" name="ChildernatHome" id="ChildernatHome" />
                    </div>
                ...
                <div className='flex flex-col md:flex-row justify-between md:mt-10'>
                    ...
                    <div className='md:w-[45%] mt-5 '>
                        <label className='text-black font-bold capitalize ' htmlFor="petathome">pet at home</label>
                        <br />
                        <input className='bg-[#D9D9D9] px-2 py-2 mt-2 rounded-sm w-full' type="text" name="petathome" id="petathome" />
                    </div>
...
export default AddYourPersonalInformation
