        ...
        <div className="border-2 border-gray-2000 py-4 px-3 hidden md:block " >
            ...
            <ul className="flex flex-col gap-5 text-left " >
                ...
                <li className='flex items-center '>
                    <Image className="w-10" src="/joinasaVeterinarianImages/Veterinaryinformation.png"
                        width={200}
                        height={200}
                        alt="image"
                    />
                    <a className='text-sm capitalize font-bold ml-2' href="#">Veterinary information</a>
                </li>
